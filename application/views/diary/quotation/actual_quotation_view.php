...
<div>
				...
				<td style="width: 70%;">
					...
					if(count($clientInfo)>0){
						foreach($clientInfo as $ck=>$cv){
							?>
							<strong><?php echo $cv->CompanyName;?></strong><br/>
							<span><?php echo $cv->PostalAdress?></span>
							<?php /*echo $cv->PhysicalAddress;*/?>
						<?php }
					}
					?>
				</td>
	...
	<div>
		<input type="submit" name="submit" value="Send" class="m-btn green" style="width: 120px;">
	</div>
</div>
<?php
echo form_close();
