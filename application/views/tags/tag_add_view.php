    ...
    <div class="trussTagForm">
        ...
        echo form_open('','class="form-horizontal"');
            ...
            <!--<div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="tag_id" class="tag_id form-control input-sm number required" />
                </div>
            </div>-->
            <div class="form-group">
                <label class="control-label col-sm-3">Description:</label>
                <div class="col-sm-9">
                    <textarea name="description" class="form-control input-sm required" rows="5"></textarea>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-3">Text:</label>
                <div class="col-sm-9">
                    <textarea name="text" class="form-control input-sm required" rows="10"></textarea>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-12">
