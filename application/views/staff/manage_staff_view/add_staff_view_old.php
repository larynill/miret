		...
		<td>
			<table>
				<tr>
					<td>IRD Number:</td>
					<td>
						<input type="text" name="irdnum" id="irdnum" class=""/>
					</td>
				</tr>
				<tr>
					<td>Account Number:</td>
					<td>
						<input type="text" name="account_number" id="account_number" class=""/>
					</td>
				</tr>
				<tr>
					<td>Tax Code:</td>
				...
				<tr valign="top">
					<td>Address:</td>
					<td><textarea name="address" id="address" style="height:80px;resize:none;font-size:12px;" class=""></textarea></td>
				</tr>
				<tr>
					<td>Email:</td>
		...
		<td>
			<table>
				...
				<tr>
					<td>Fixed value:</td>
					<td>
						<input type="text" id="fixed_rate" name="fixed_rate" class="" placeholder="if fixed here..." />
					</td>
				</tr>
				<tr>
					<td>Tax:</td>
                ...
                <tr>
                    <td>Can Add Job?</td>
                    <td>
                        <input type="checkbox" name="isCanAddJob" id="isCanAddJob" value="1" style="width: 20%;"/>
                    </td>
                </tr>
                <tr>
                    <td>Qualified Inspector?</td>
                    <td>
                        <input type="checkbox" name="isQualifiedInspector" id="isQualifiedInspector" value="1" style="width: 20%;"/>
                    </td>
                </tr>
			</table>
		</td>
	...
	<tr>
		<td colspan="2" style="text-align: right;">
            ...
            <div class="col-sm-2 pull-right">
                <button type="submit" name="update" class="qsAddBtn btn btn-sm btn-primary" >Add</button>
