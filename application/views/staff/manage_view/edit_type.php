    ...
    foreach($salary_type as $v){
        ...
        <table class="typeTable">
            <tr>
                <td>Type:</td>
                <td>
                    <input type="text" name="type" value="<?php echo $v->type; ?>" class="required" />
                </td>
            </tr>
            <tr>
                <td>Fixed:</td>
                <td>
                    <input type="checkbox" name="hasfixed" value="true" <?php echo $v->hasfixed == "true" ? 'CHECKED' : ''; ?> style="width: 10%;"/>
                </td>
            </tr>
            <tr>
