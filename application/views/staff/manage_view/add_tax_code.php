...
echo form_open('');
    ...
    <table class="taxCodeTable">
        <tr>
            <td>Tax Code:</td>
            <td>
                <input type="text" name="tax_code" class="required" />
            </td>
        </tr>
		<tr>
			<td>SL Start:</td>
			<td>
				<input type="text" name="sl_starting_gross" value="0" class="required isMoney" />
			</td>
		</tr>
		<tr>
			<td>CEC Start:</td>
			<td>
				<input type="text" name="cec_starting_gross" value="33" class="required isMoney" />
			</td>
		</tr>
        <tr>
