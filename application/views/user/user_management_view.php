...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="pull-right">
            <button class="btn btn-primary btn-sm user_management" data-toggle="tooltip" data-placement="left" id="add" title="Add user"><i class="fa fa-fw fa-user"></i> </button>
            <button class="btn btn-primary btn-sm user_management disabled-btn" data-toggle="tooltip" data-placement="left" id="delete" title="Delete user"><i class="fa fa-fw fa-minus-circle"></i> </button>
            <button class="btn btn-primary btn-sm user_management disabled-btn" data-toggle="tooltip" data-placement="left" id="edit" title="Edit user"><i class="fa fa-fw fa-pencil"></i> </button>
        </div>
    </div>
</div><br/>
<div class="row">
    <div class="col-lg-12">
        <div id="userManagement_table" class="grid" style="border: 1px solid #000000;height: 500px;"></div>
    </div>
</div