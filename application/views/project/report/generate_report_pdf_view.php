<style>
    ...
    .content-div > ul > li:not(.skip) {
        counter-increment:yourCounter;
        list-style:none;
    }
    .content-div > ul > li:not(.skip):before {
        content:counter(yourCounter) ". ";
    }
    .content-div > ul > li.skip {
        list-style: none;
    }
    .content-div > ul > li{
        padding: 10px;
                ...
                <div>
                                    ...
                                    if(count($_val) > 0){
                                        foreach($_val as $v){
                                            ...
                                            if(file_exists($dir . '/' . $val->id . '/photos/' . $v->photo_name)){
                                                ...
                                                <td style="width: 33.3333%;padding: 20px 10px;">
                                                    <img src="<?php echo base_url() . 'uploads/job/' . $val->id . '/photos/' . $v->photo_name?>" style="width: 100%;">
                    ...
                    <div class="content-div">
                        <ul>
                            ...
                            <li class="skip">Note- For the purpose of this document Synergy Building Consultants Limited is also known as Synergy.
                            </li>
                            <li>Our responsibility in connection with this report is limited to the person or party to whom the report is addressed and we disclaim all responsibility
                                to any other party with reference to us.</li>
                            <li>This report is a visual one only of the building elements which may be seen easily during the inspection process and does not include any item
                                that is closed in or concealed including (but not limited to) flooring, walls, ceiling, framing, plumbing and drainage, heating, ventilation and wiring.</li>
                            <li>Unless expressly stated, we have made no detailed survey of the property in terms of boundary or contour surveys, geotechnical or hydrological
                                ...
                                the information available at the time and information provided by the client and/or third parties.</li>
                            <li>Where another party has supplied information to us for the purpose of the report, this information is believed to be reliable but we can accept no
                                ...
                                or companies.</li>
                            <li>It is agreed that this report is compiled and completed by Synergy on the basis that it is not liable for any loss or damage resulting from its failure
                                or omission in identifying any condition or latent defect that may be concealed at the time of inspection.</li>
                            <li>Unless otherwise stated and specifically commissioned, no documentation we provide including any drawings are to be considered design
                                    ...
                                    penalties incurred regarding non-compliance with this part of the building legislation.</li>
                            <li>The cost and revenue figures provided in this report are estimates only and are based on information available at the time and/or information
                                    ...
                                    Limited does not take any responsibility for the financial outcomes of any property development to which the figures in the report relate.</li>
                            <li>Time frames outlined in this report are estimates only. Timeframes are based on what could be reasonably expected or achieved over a period of
                                    ...
                                    Consultants Limited does not take responsibility for the accuracy of timeframes.</li>
                            <li>Any Liability Synergy attracts to the client for defects it could easily viewed by omitted to notice and/or arising from, the provision of this report is
                                    limited to the aggregated amount of the fee, with a multiple of five (5) charged by Synergy for this report.</li>
                            <li>Synergy’s responsibility in connection with this inspection report is limited to the client to whom this report is addressed and not its assignees or
                                    ...
                                    the fee is deemed as acceptance of all conditions.</li>
                            <li>This report may be not reproduced, in whole or part, without our prior written approval.</li>
                            <li class="skip"><div class="title">Terms of Business</div></li>
                            <li class="skip">Note- For the purpose of this document Synergy Building Consultants Limited is also known as Synergy.</li>
                            <li>Form of Engagement: Synergy agrees to undertake a visual inspection of the property in order to provide a report on the estimated scope of
                                ...
                                the property is free from defect.</li>
                            <li>Exclusions: Without limiting cause 1, the client acknowledges that the inspection undertaken by Synergy does not cover the following items and
                            ...
                            <li>Leaking Building Syndrome: It is agreed that Synergy is not liable for any loss, cost, defect or damage whatsoever to any building, structure, or
                            ...
                            <li>Prices: The client shall pay Synergy the prices stated in this Estimate/Report for the services (“the prices”). All additional out of pocket expenses
                                incurred by Synergy will be payable for the Client, including but not limited to accommodation and meals, travel and administration costs.</li>
                            <li>Payment: Synergy will invoice the Client monthly and payment is due on the 20th of the month following the invoice date without deduction or
                                ...
                                Lending Rate of Synergy’s bank from the due date of payment until the actual date of payment of all amounts.</li>
                            <li>Clients Premises: The client shall at all reasonable times give Synergy’s authorised personnel free and safe access to the Client’s premises and any
                                ...
                                security in effect at those premises.</li>
                            <li>Intellectual Property: All intellectual property developed by Synergy during the term of this of this Estimate/Report shall remain the property of
                                ...
                                this Estimate.</li>
                            <li>Termination: Synergy shall have the right to terminate this Estimate/Report (without prejudice to any other of its rights) immediately if the Client
                                commits a breach of this Estimate/Report and the breach is not remedied within fourteen (14) days of notification of the breach by Synergy.</li>
                            <li>Warranty: Synergy warrants that the Services will be provided with due care and diligence, taking into account the nature and scope of the work.
                                ...
                                of such efforts.</li>
                            <li>Liability: Synergy will not be liable to any third party for any incidental, indirect, special or consequential loss or damage, including but not limited
                                ...
                                the breach.</li>
                            <li>Indemnity: The Client hereby indemnifies, and will keep Synergy indemnified, against all obligations and liabilities incurred by any act or omission
                                of the Client in relation to the Estimate/Report.</li>
                            <li>Confidential Information: The parties shall keep all business information gained in relation to this Estimate/Report confidential and shall ensure
                                ...
                                in the public domain without a party having breached its obligations under this Estimate/Report.</li>
                            <li>Force Majeure: If Synergy is unable to perform its obligations under this Estimate/Report due to events beyond its control, then Synergy shall be
                                ...
                                Estimate/Report.</li>
                            <li>General: This Estimate/Report supersedes all previous communications, representations, agreements or understandings, verbal or written,
                                ...
                                and construed in accordance with the law of New Zealand.</li>
                        </ul>
                    </div>
                </div>
            <?php
